...
const contributionStatusLabels: Record<string, string> = { NOT_SENT: "لم يتم الإرسال", INVITATION_SENT: "أرسلت الدعوة", OPENED: "تم فتح الطلب", IN_PROGRESS: "قيد العمل", SUBMITTED: "تم التسليم", UNDER_REVIEW: "قيد المراجعة", NEEDS_AMENDMENT: "يحتاج تعديل", COMPLETED: "مكتمل", OVERDUE: "متأخر", CANCELLED: "ملغي" };
