...
export const CONTRIBUTION_DEFINITIONS:readonly ContributionDefinition[]=[
  ...
  {requirementId:"5-23-3-r5",code:"5.23.3.5",unit:"5.23.3",number:"05",sections:["linkDocumentation","evidence"],labels:{linkDocumentation:"توثيق رابط الاستقبال",evidence:"تجهيز الإثبات"}},
] as const;
