...
function PreviewButton({ children }: { children: string }) {
  return <Button disabled title="غير متاح في وضع المعاينة"><LockKeyhole className="h-4 w-4" />{children}</Button>;
}
