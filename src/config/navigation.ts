import { Activity, Archive, BarChart3, Bell, ClipboardCheck, ClipboardList, FileCheck2, Gauge, Handshake, Landmark, Lightbulb, ListTodo, ScrollText, Settings, ShieldCheck, Target, TrendingUp, UserCircle, Users, type LucideIcon } from "lucide-react";
...
export const navGroups: NavGroup[] = [
  { label: "الجاهزية المؤسسية", items: [
    ...
    { href: "/challenges", label: "التحديات", icon: Lightbulb, permissions: ["challenge.view"] },
  ...
  { label: "المتابعة", items: [
    ...
    { href: "/evidence-matrix", label: "مصفوفة أدلة القياس", icon: ClipboardList, permissions: ["evidence.view"] },
    { href: "/evidence-repository", label: "مستودع الأدلة", icon: Archive, permissions: ["evidence.view"] },
